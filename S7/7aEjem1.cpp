...
vector<double> vector_diferenciales(vector<int> v);
...
int main() {
    ...
    cout << "Suma menores 70: " << suma_menores_70(v) << endl;
    vector<double> v2 = vector_diferenciales(v);
    cout << "Vector de diferencias: " << endl;
    imprimir(v2);
    return 0;
}
